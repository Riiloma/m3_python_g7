...
def verificar(alternativas, eleccion):
    ...
    Args:
        alternativas (string): entrega las alternativas
        eleccion (list): una lista con elecciones a tomar

    Returns:
        string: entrega True en caso de que se compla la condicion y False si no se cumple
    """
